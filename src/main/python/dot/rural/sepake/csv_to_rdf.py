...
def row_graphs(url, keep):
    ...
    #TODO add more PROV
    row_adders = [(lambda g : _add_csv_row(g, file_id, row)) for row in csv.DictReader(csv_input) if keep(row)]
    return (main_graph, row_adders)
