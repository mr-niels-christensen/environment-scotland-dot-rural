...
import logging
import webapp2
from dotruralsepake.oai import OAIHarvester
from dotruralsepake.get_details import PureRestPublicationHarvester
...
def _load_pure_data(graphid):
    ...
    from dotruralsepake.pure import university_of_aberdeen
...
def _load_ukeof_data(graphid):
    ...
    from dotruralsepake.ukeof import ukeof_graphs
